    ...
    def call_api_encrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                print("Response data:", data)  # In ra để debug
                ...
                if "encrypted_message" in data:
                    ...
                    print("Key'encrypted_message' không tồn tại trong response:", data)
            else:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if "decrypted_message" in data:
                    ...
                    print("Key 'decrypted_message' không tồn tại trong response:", data)
            else:
                print("Error while calling API: ", response.status_code)
        except requests.exceptions.RequestException as e:
            print("Error: %s" % str(e))
